...
creatives in 34.2s for $0.134** — because generation happens once per missing
...
|---|---|---|
| 1 · Accelerate campaign velocity | `runCampaign()` — brief in, 24 validated creatives out in 34.2s | **Delivered** |
